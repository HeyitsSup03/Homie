...
const Login: React.FC = () => {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden">
      ...
      {/* ══ LOGIN CARD — centered on right canvas ══ */}
      <div className="absolute inset-y-0 right-0 w-[46%] flex items-center justify-center z-10">
        <div className="w-full max-w-[390px] mx-auto px-4">
          ...
          {/* Card */}
          <div className="bg-white rounded-[24px] shadow-[0_8px_48px_rgba(0,0,0,0.09)] px-9 py-10">

            {/* Header */}
            <h1 className="text-[1.85rem] font-extrabold text-[#1a1a1a] text-center leading-tight mb-1 tracking-[-0.02em]">
              <span className="text-[#4A7546]">Log In to Homie</span>
            </h1>
            <p className="text-center text-[0.8rem] text-[#888] mt-3 mb-7">
              New to Homie?{' '}
              <Link to="/register" className="text-[#4A7546] font-semibold hover:underline">
                Create Account →
              </Link>
            </p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-0">
              ...
              <div className="mb-5">
                ...
                <input
                  ...
                  placeholder=""
                  required
                  className="w-full border-0 border-b border-[#c8c4be] bg-transparent text-[0.88rem] text-[#1a1a1a] pb-[6px] focus:outline-none focus:border-[#4A7546] transition-colors duration-200 placeholder:text-[#bbb]"
                />
              </div>
              ...
              <div className="flex justify-end mb-6">
                <Link
                  to="/forgot-password"
                  className="text-[0.75rem] text-[#888] hover:text-[#4A7546] transition-colors"
                >
                  Forgot Password?
                </Link>
              </div>
